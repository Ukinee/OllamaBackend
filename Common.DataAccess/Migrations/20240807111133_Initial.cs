        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Personas_Identities_IdentityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderPersonaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_Personas_SenderPersonaId",
                        column: x => x.SenderPersonaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonaConversations", x => new { x.ConversationsId, x.PersonasId });
                    table.ForeignKey(
                        name: "FK_PersonaConversations_Conversations_ConversationsId",
                        column: x => x.ConversationsId,
                        principalTable: "Conversations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonaConversations_Personas_PersonasId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_SenderPersonaId",
                table: "Messages",
                column: "SenderPersonaId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonaConversations_PersonasId",
                table: "PersonaConversations",
                column: "PersonasId");

            migrationBuilder.CreateIndex(
                name: "IX_Personas_IdentityId",
                table: "Personas",
                column: "IdentityId",
                unique: true);
